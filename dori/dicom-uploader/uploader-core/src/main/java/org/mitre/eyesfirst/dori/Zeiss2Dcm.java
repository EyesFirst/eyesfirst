...
public class Zeiss2Dcm extends Dcm2Dcm {
	...
	public DicomObject convert(Uploader uploader, File src, File dest, String efid) throws IOException {
		return recodeImage(uploader, src, dest, efid);
	}
	 ...
	 */
	public DicomObject recodeImage(Uploader uploader, File src, File dest, String efid)
			throws IOException {
		if (!imgFile.exists())
		...
		try {
			...
			MakeDcmSup110.updateDicomObject(uploader, this, newDs);
			...
			uploader.associateQueryString(outputFile.getName(), queryString);
