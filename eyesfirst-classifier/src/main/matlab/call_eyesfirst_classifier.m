...
function [] = call_eyesfirst_classifier(eyes_first_data_dir)
...
% taskList = {'dicom2mat','motionCorrect','initialGating','initialLayerBdrys','initialLayerBoundarySmoothing','generateThicknessMaps','generateStatistics','identifyInternalLayers','CFARProcess','GenerateExceedanceClusters','CalculateMomentsExceedClust'};