...
function [gim,g2im] = gradientImage(im,sd,mf,ofilebase)
...
extent2 = mf*sd2;
extent3 = mf*sd3;
imx = gauskerndiff(im,n1,n2,n3,sd1,sd2,sd3,extent1,extent2,extent3);
n1 = [];
n2 = 1;
n3 = [];
imy = gauskerndiff(im,n1,n2,n3,sd1,sd2,sd3,extent1,extent2,extent3);
n1 = [];
n2 = [];
n3 = 1;
imz = gauskerndiff(im,n1,n2,n3,sd1,sd2,sd3,extent1,extent2,extent3);
if g1flag == 1
   gim = (imx.^2 + imy.^2 + imz.^2).^(0.5);
else
    gim = [];
end;
if g2flag == 1
    ...
    n2 = [];
    n3 = [];
    imxx = gauskerndiff(im,n1,n2,n3,sd1,sd2,sd3,extent1,extent2,extent3);
    n1 = [];
    n2 = 2;
    n3 = [];
    imyy = gauskerndiff(im,n1,n2,n3,sd1,sd2,sd3,extent1,extent2,extent3);
    n1 = [];
    n2 = [];
    n3 = 2;
    ...
    n2 = 1;
    n3 = [];
    imxy = gauskerndiff(im,n1,n2,n3,sd1,sd2,sd3,extent1,extent2,extent3);
    n1 = 1;
    n2 = [];
    n3 = 1;
